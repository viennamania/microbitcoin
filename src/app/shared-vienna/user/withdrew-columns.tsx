...

  {
    ...
    render: (_: any, row: any) => (
      <div>
        ...
        <Link
          //href={
            ///routes.user.withdrewDetails(row.id)
          //}
          href={`/user/withdrew/${row.id}?sequenceNumber=${row?.sequenceNumber}`}
...

  {
    title: (
      <HeaderCell
        ...
        sortable
        ascending={
          sortConfig?.direction === 'asc' && sortConfig?.key === 'withdrawAt'
        }
      />
    ),
    onHeaderCell: () => onHeaderCellClick('withdrawAt'),
