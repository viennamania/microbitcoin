...
export const getColumns = ({
...

  {
    ...
    render: (_: any, row: any) => (
      ...
      <Link
        className=' h-14 flex flex-row items-center justify-start gap-3'


        href={`/usermain/boards/notice/${row?.id}`}
      ...
      >
        <Text className='text-start font-extrabold  text-sm xl:text-base'>
          {row.title}
        </Text>
      </Link>
