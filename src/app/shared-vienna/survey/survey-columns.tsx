...
/* Pi icons number 1,2,3,4,5,6,7,8*/

import {
  PiNumberCircleOne, PiNumberCircleTwo, PiNumberCircleThree, PiNumberCircleFour, PiNumberCircleFive, PiNumberCircleSix, PiNumberCircleSeven, PiNumberCircleEight
} from 'react-icons/pi';
...
export const getColumns = ({
  ...
  /* id Pi icons number 1,2,3,4,5,6,7,8*/
...

  {
    ...
    render: (value: string, row: any) => (
      ...
      <div className='flex flex-row items-center justify-start gap-5'>
        ...
        {/*
        {(row.id === '20') && (
          <PiNumberCircleFour className="h-4 w-4" />
        )}
        */}

        <Text className=" w-6 ">{row.id}</Text>
