...
useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      //const res = await fetch(`/api/vienna/feed/getFeedbackStatisticsMonthByEmail?_email=${session?.user?.email}`);
      ...
      const res = await fetch(`/api/vienna/feed/getFeedbackStatisticsMonthByEmail?_email=${session?.user?.email}&_mealDateStart=${
        mealDateStart
      }&_mealDateEnd=${  
        mealDateEnd
      }
