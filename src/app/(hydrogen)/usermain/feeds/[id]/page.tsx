  ...
  */
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const res = await fetch(`/api/vienna/feed/getFeedById?_id=${id}&_userId=${userData?.id}`);
  ...
  const scrap = async () => {
    ...
    // update my like list
    const res = await fetch(`/api/vienna/feed/scrap?_id=${id}&_userId=${userData?.id}&_userNickname=${userData?.nickname}&_userAvatar=${userData?.avatar}&_userEmail=${userData?.email}`);
  ...
  const unscrap = async () => {
      ...
      // update my like list
      const res = await fetch(`/api/vienna/feed/unscrap?_id=${id}&_userId=${userData?.id}&_userNickname=${userData?.nickname}&_userAvatar=${userData?.avatar}&_userEmail=${userData?.email}`);
  ...
  const like = async () => {
    ...
    // update my like list
    const res =  await fetch(`/api/vienna/feed/like?_id=${id}&_userId=${userData?.id}&_userNickname=${userData?.nickname}&_userAvatar=${userData?.avatar}&_userEmail=${userData?.email}`);
  ...
  const unlike = async () => {
    ...
    // update my like list
    const res = await fetch(`/api/vienna/feed/unlike?_id=${id}&_userId=${userData?.id}&_userNickname=${userData?.nickname}&_userAvatar=${userData?.avatar}&_userEmail=${userData?.email}`);
