...
const classes = {
  ...
  // hidden header hight 0px
  // remove heaer
  thead:
    ' [&_thead .rc-table-cell]:hidden [&_thead]:h-0 [&_thead]:hidden [&_thead]:text-left [&_thead]:rtl:text-right [&_th.rc-table-cell]:text-xs [&_th.rc-table-cell]:font-semibold [&_th.rc-table-cell]:tracking-wider [&_th.rc-table-cell]:text-gray-500',
  ...
  ///thead:
  //  '    [&_thead]:text-left [&_thead]:rtl:text-right [&_th.rc-table-cell]:text-xs [&_th.rc-table-cell]:font-semibold [&_th.rc-table-cell]:tracking-wider [&_th.rc-table-cell]:text-gray-500',
  
  
  tCell:
    ///'[&_.rc-table-cell]:px-3 [&_th.rc-table-cell]:py-3 [&_td.rc-table-cell]:py-4',
    '[&_.rc-table-cell]:px-3 [&_th.rc-table-cell]:py-3 [&_td.rc-table-cell]:py-1',
  ...
  return (
    <RcTable
      className={cn(
        ...
        /*
style="width: 800px; min-width: 100%; table-layout: auto;"
*/
        ///'w-full min-w-full table-auto',
      ...
      emptyText={
        emptyText || (
          <div className="py-5 text-center lg:py-8">
            <Empty /> <Text className="mt-3">정보가 없습니다.</Text>
          </div>
        )
      }
      {...props}
