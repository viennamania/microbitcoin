...
import { PiCaretUpDown, PiCaretDownLight, PiCaretDownBold } from 'react-icons/pi';
...
export default function SelectBox<OptionType extends SelectOption>({
  ...
  /////suffix = <PiCaretDownLight className="h-5 w-5" />,
  //suffix = <PiCaretDownBold className="h-5 w-5" />,
          ...
          <>
            ...
            <div ref={ref} className="h-full">
              <Listbox.Button
                ...
                onClick={() => {
                  console.log('Listbox.Button onClick');
