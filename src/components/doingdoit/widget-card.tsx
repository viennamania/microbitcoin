    ...
    >
      <div
        className={cn(
          ...
          action && 'flex items-start justify-start',
      ...
      >
        <div>
          <Title
            as="h3"
            className={cn('text-base font-semibold sm:text-base', titleClassName)}
          >
            {title}
          </Title>
          {description && (
        ...
        {action && <div className={cn('ps-3', actionClassSName)}>{action}</div>}
