...
const ListDiet: NextPage<List3Type> = ({
  cakeDescription,
  frameDiv,
  showRectangleIcon,
  propOpacity,
    ...
    >
      ...
      <div className="self-stretch flex flex-col items-start justify-start gap-[20px]">
        <div className="self-stretch flex flex-row items-center justify-start gap-[8px]">
          <img className="relative w-6 h-6" alt="" src="/username/images/avatar.svg" />
      ...
      <div className="self-stretch rounded-tl-none rounded-tr-3xl rounded-b-3xl bg-background flex flex-col items-center justify-end p-5 gap-[12px]">
        <div className="self-stretch flex flex-row items-center justify-start gap-[8px]">
          ...
          <img className="relative w-5 h-5" alt="" src="/usermaiin/images/annotation.svg" />
          <div className="flex-1 relative">
