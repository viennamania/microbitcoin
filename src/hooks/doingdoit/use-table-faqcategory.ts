  ...
  function handleDelete(id: string | string[]) {
    ...
    */
    ...
    const deleteData = async () => {
      ...
      await fetch(`/api/vienna/faq/deleteOneCategory?id=${id}`);
  ...
  */
  ...
  const handleIncrementOrderNumber = (id: string) => {
    ...
    const result = async () => {
      ...
      const res = await fetch('/api/vienna/faq/incrementCategoryOrderNumber?id=' + id );
  ...
  const handleDecrementOrderNumber = (id: string) => {
    ...
    const result = async () => {
      ...
      const res = await fetch('/api/vienna/faq/decrementCategoryOrderNumber?id=' + id );
