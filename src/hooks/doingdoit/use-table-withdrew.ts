...
export function useTable<T extends AnyObject>(
  ...
  */
  ...
  function handleDelete(id: string | string[]) {
    ...
    */
    ...
    const deleteData = async () => {
      ...
      const res = await fetch('/api/vienna/user/getAllWithdrewers', {
        method: 'POST',
        headers: {
  ...
  const fetchData = async (
    ...
    //const res = await fetch(`/api/vienna/user/getAllUsers?_limit=${countPerPage}&_page=${currentPage}&_sort=${sortConfig.key}&_order=${sortConfig.direction}&_q=${searchTerm}`);
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const res = await fetch(`/api/vienna/user/getAllWithdrewers?_limit=${countPerPage}&_page=${currentPage}&_sort=${sortConfig.key}&_order=${sortConfig.direction}&_q=${searchTerm}`);
    ...
    const fetchTotalCount = async () => {
      const res = await fetch(`/api/vienna/user/getWithdrewerCount?_q=${searchTerm}`);
